...
public class MySlickAdapter extends PagerAdapter {
    ...
    public String[] slick_artistNames = {"Nirvana","Metallica","Oasis", "Loquillo","The Beatles","Taylor Swift",
                                         "Steven Tyler","Metallica","Oasis", "Loquillo","The Beatles","Taylor Swift",
                                         "Steven Tyler","Metallica","Oasis", "Loquillo","The Beatles","Taylor Swift"};
    ...
    public int[] slick_imageViews = {R.drawable.nirvanatower, R.drawable.rockroyalty, R.drawable.nirvanatower, R.drawable.rockroyalty, R.drawable.nirvanatower, R.drawable.rockroyalty,
                                     R.drawable.nirvanatower, R.drawable.rockroyalty, R.drawable.nirvanatower, R.drawable.rockroyalty, R.drawable.nirvanatower, R.drawable.rockroyalty,
                                     R.drawable.rockroyalty, R.drawable.nirvanatower, R.drawable.rockroyalty, R.drawable.nirvanatower, R.drawable.rockroyalty, R.drawable.nirvanatower};
